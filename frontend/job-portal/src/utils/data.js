...
export const employerFeatures = [
  ...
  },
  {
    ...
    description:
      "Track your hiring performances with detailed analytics and insights on candidate engagement.",
  },
  {
    icon: Shield,
...
export const CATEGORIES = [
  ...
  { value: "IT & Softwares", label: "IT & Softwares" },
...
export const SALARY_RANGES = [
  "Salário Mínimo",
  "Entre um Salário mínimo e três",
  "Acima de três Salário Mínimo",
];
